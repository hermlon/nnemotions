...
from emotion_detection.local_binary_pattern import BinaryPatternAnalysis
import numpy
import pickle
import datetime
...
class LBPEmotionDetection:
    ...
    def save_network(self, info=''):
        nnt = NNTraining(learningrate=self.nn.learningrate,
                         ...
                         bias=self.nn.bias,
                         activation_function=repr(self.nn.activation_function),
    ...
    def new_network(self, layersizes, activation_function, cost_function, bias, learningrate, blocksize):
        self.nn = Network(layersizes=layersizes, activation_function=activation_function, bias=bias,
