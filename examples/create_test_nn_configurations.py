...
n = NNConfiguration(blocksize=blocksize, bias=bias, activation_function=SigmoidActivationFunction,
                                cost_function=LinearActivationFunction, learningrate=0.2, layersizes=(944, 500, 80, 7))
env.db.add(n)
env.db.commit()