...
def query(tries, learn, data):
    for i in range(tries):
        ...
        img = training_example.get_img(NN_EMOT_IMG_DIR)
        ed.query(img, des_o, learn=learn)
...
try_configuration([23600, 1000, 300, 40, len(emotions)], SigmoidFunction, Linear, True, 5, 0.06, 50)
