...
class BinaryPattern:
    ...
    coordinates = [(0, 0), (0, 1), (0, 2), (1, 2), (2, 2), (2, 1), (2, 0), (1, 0)]
    ...
    def __init__(self, input):
        ...
        for coordinate in self.coordinates:
            self.pattern.append(self.pixel_value(coordinate))
...
class BinaryPatternAnalysis:
    ...
    def __init__(self, input, blocksize):
        self.matrix = input
        # round up if the blocksize does not fit the matrix exactly. The blocks in the corner will therefore be smaller
        blockslength = (math.ceil(self.matrix.shape[0] / blocksize[0])) * (math.ceil(self.matrix.shape[1] / blocksize[1]))
